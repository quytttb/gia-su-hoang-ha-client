               ...
               <section className="section-padding">
                    <div className="container-custom">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                              {tutors.map((tutor) => (
                                   <div key={tutor.id} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-lg">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                              <div>
                                   <div className="mb-5">
                                        ...
                                        <p className="text-gray-700">265 - ĐƯỜNG 06 - MẶT BẰNG 08, PHƯỜNG NAM NGẠN, THÀNH PHỐ THANH HOÁ, TỈNH THANH HOÁ</p>
                                   </div>
                                   <div className="mb-5">
                                   ...
                                   <div>
                                        ...
                                        <p className="text-gray-700 mb-1">Thứ 2 - Thứ 6: {centerInfo.workingHours.weekdays}</p>

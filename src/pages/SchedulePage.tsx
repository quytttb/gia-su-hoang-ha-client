    ...
    <Layout>
      ...
      <section className="bg-gray-100 dark:bg-gray-900 py-16">
        <div className="container-custom text-center">
          <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200 mb-4">Lịch Học</h1>
          ...
          <div className="lg:col-span-2">
            ...
            {viewType === 'table' ? (
              <>
                ...
                {filteredSchedules.length > 0 ? (
                      ...
                      <tbody>
                        {filteredSchedules.map(schedule => (
                          <tr key={schedule.id} className="border-t border-gray-200 dark:border-gray-700">
                            ...
                            <td className="py-3 px-4 text-gray-800 dark:text-gray-200">{schedule.tutor}</td>
                            <td className="py-3 px-4 text-gray-800 dark:text-gray-200">{schedule.room}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <div className="bg-white p-8 rounded-lg shadow-md text-center">
                    <p className="text-gray-500 dark:text-gray-400">Không có lịch học nào vào ngày đã chọn.</p>
                  </div>
                )}
              </>
            ) : (
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="mb-6">
                  <p className="text-gray-600 dark:text-gray-400 mb-4">Chọn ngày trên lịch để xem chi tiết:</p>
                  ...
                  <div className="space-y-4">
                    {personalSchedules.map(schedule => (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Giáo viên: {schedule.tutor}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Phòng: {schedule.room}</p>
                      </div>
                    ))}
                  </div>
                ) : (

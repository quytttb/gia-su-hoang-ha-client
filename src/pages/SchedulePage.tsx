...
import { getAllSchedules, getSchedulesByDate, getSchedulesByUserPhone } from '../services/dataService';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                                            ...
                                                            {filteredSchedules.map(schedule => (
                                                                 <div key={schedule.id} className="border-l-4 border-primary pl-4 py-2">
                                                                      ...
                                                                      <p className="text-sm text-gray-600">
                                                                           {schedule.startTime} - {schedule.endTime} | {schedule.tutor} | Phòng: {schedule.room}
                                                                      </p>
                                                                 </div>
                                                            ))}
                                                       </div>
                                                  ) : (
                                                       <p className="text-gray-500 italic">Không có lịch học nào vào ngày đã chọn.</p>
                                                  )}
                                             </div>
                                        )}
                                   </div>
                         ...
                         <div>
                                        ...
                                        <form onSubmit={handlePhoneSubmit}>
                                             <div className="mb-4">
                                                  ...
                                                  <input
                                                       ...
                                                       className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary ${phoneError ? 'border-red-500' : 'border-gray-300'
                                                            }`}
                                        ...
                                        {personalSchedules.length > 0 ? (
                                             <div className="space-y-4">
                                                  {personalSchedules.map(schedule => (
                                                       <div key={schedule.id} className="border-b border-gray-200 pb-4 last:border-0">
                                                            ...
                                                            <p className="text-sm text-gray-600">Giờ: {schedule.startTime} - {schedule.endTime}</p>
                                             ...
                                             <div className="text-center py-4">
                                                  <p className="text-gray-500">Không tìm thấy lịch học nào cho số điện thoại này.</p>
                                                  <p className="text-sm text-gray-500 mt-2">Nếu bạn đã đăng ký, vui lòng kiểm tra lại số điện thoại hoặc liên hệ với trung tâm.</p>
                                             </div>
                                        )}
                                   </div>
                              )}
                              ...
                              <div className="mt-6 bg-gray-100 p-6 rounded-lg">
                                   ...
                                   <p className="text-gray-700 text-sm mb-2">Nếu bạn gặp vấn đề khi xem lịch học, vui lòng liên hệ với chúng tôi:</p>

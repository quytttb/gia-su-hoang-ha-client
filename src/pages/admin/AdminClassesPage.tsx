          ...
          try {
               ...
               if (editingClass && editingClass.id) {
                    ...
                    if (result.data) {
                         ...
                         setFilteredClasses(prev => prev.map(c => c.id === convertedClass.id ? convertedClass : c));
                    }
               } else {
                    // Create new class
               ...
               <div className="space-y-6">
                    ...
                    <div className="bg-card rounded-lg p-6 border flex items-center justify-between">
                         <div>
                              ...
                              <p className="text-muted-foreground">Thêm, chỉnh sửa và quản lý các lớp học của trung tâm.</p>
                         </div>
                         <Button onClick={() => {
                              setEditingClass(undefined);
                              setIsFormOpen(true);
                    ...
                    <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
                         <DialogContent>
                              <DialogHeader>
                                   ...
                                   <DialogDescription>
                                        Bạn có chắc chắn muốn xóa lớp học "{classToDelete?.name}"? Hành động này không thể hoàn tác.
                                   </DialogDescription>
                              </DialogHeader>
                              <DialogFooter>
                                   <Button

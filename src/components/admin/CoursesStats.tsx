...
import coursesService, { CourseStats } from '../../services/firestore/coursesService';
...
const CoursesStats = () => {
     ...
     useEffect(() => {
          ...
          const unsubscribe = coursesService.subscribeToCoursesForAdmin((coursesData) => {
     ...
     return (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/20 p-6 transition-colors duration-200">
               <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200">Thống kê khóa học</h2>
                    ...
                    <>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                              ...
                              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                                   <div className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.activeCourses}</div>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div>
                                   ...
                                   <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded">
                                             <span className="text-gray-700 dark:text-gray-300">Khóa học được cập nhật</span>

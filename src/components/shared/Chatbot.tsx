...
const defaultFAQs: ChatbotFAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Học phí các khóa học dao động từ 1.800.000đ đến 4.000.000đ tùy vào loại khóa học. Vui lòng xem chi tiết tại trang Khóa học hoặc liên hệ với chúng tôi để biết thêm chi tiết.',
  },
  {
    keywords: ['đăng ký', 'tham gia', 'ghi danh'],
    question: 'Làm thế nào để đăng ký khóa học?',
    answer:
      'Để đăng ký khóa học, bạn có thể: 1) Đăng ký trực tuyến trên trang web của chúng tôi tại mục Khóa học, 2) Liên hệ trực tiếp qua số điện thoại 0385.510.892 - 0962.390.161, hoặc 3) Đến trực tiếp trung tâm tại 265 - ĐƯỜNG 06 - MẶT BẰNG 08, PHƯỜNG NAM NGẠN, THÀNH PHỐ THANH HOÁ, TỈNH THANH HOÁ.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Giáo viên tại trung tâm Gia Sư Hoàng Hà đều có trình độ chuyên môn cao, nhiều năm kinh nghiệm giảng dạy. Nhiều giáo viên có bằng Thạc sĩ, Tiến sĩ và các chứng chỉ chuyên môn.',
  },
  {
    keywords: ['lịch học', 'thời khóa biểu'],
    question: 'Lịch học được sắp xếp như thế nào?',
    answer:
      'Lịch học được sắp xếp linh hoạt dựa trên từng khóa học. Thông thường, các lớp học diễn ra vào buổi tối các ngày trong tuần hoặc cả ngày vào cuối tuần. Bạn có thể xem chi tiết lịch học tại trang Lịch học trên website.',
  },
  {
    keywords: ['hỗ trợ', 'thêm', 'bổ trợ'],
    question: 'Trung tâm có các dịch vụ hỗ trợ học tập nào?',
    answer:
      'Ngoài các khóa học chính, chúng tôi còn cung cấp các dịch vụ hỗ trợ như: gia sư 1-1, lớp học bổ trợ, tài liệu học tập online, và các buổi ôn tập định kỳ.',
  },
  {
    keywords: ['hoàn tiền', 'đổi khóa', 'hủy'],
    question: 'Chính sách hoàn tiền của trung tâm là gì?',
    answer:
      'Trung tâm có chính sách hoàn tiền nếu học viên không hài lòng sau 3 buổi học đầu tiên. Học viên cũng có thể đổi sang khóa học khác có giá trị tương đương. Vui lòng liên hệ với chúng tôi để biết thêm chi tiết.',
  },
];
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      content:
        'Xin chào! Tôi là trợ lý ảo của Trung tâm Gia Sư Hoàng Hà. Tôi có thể giúp gì cho bạn?',
      isBot: true,
    },
  ]);
  ...
  const generateBotResponse = (input: string): ChatMessage => {
    ...
    if (
      ...
      return {
        id: Date.now().toString(),
        content:
          'Xin chào! Tôi có thể giúp gì cho bạn về các khóa học tại Trung tâm Gia Sư Hoàng Hà?',
        isBot: true,
      };
    }
    if (lowercaseInput.includes('cảm ơn') || lowercaseInput.includes('thank')) {
      return {
        id: Date.now().toString(),
        content:
          'Không có gì! Rất vui được giúp đỡ bạn. Nếu bạn có câu hỏi nào khác, đừng ngại hỏi tôi nhé.',
        isBot: true,
      };
    }
    return {
      id: Date.now().toString(),
      content:
        'Tôi chưa hiểu rõ câu hỏi của bạn. Bạn có thể hỏi về học phí, lịch học, đăng ký khóa học, địa chỉ trung tâm, hoặc thông tin liên hệ.',
      isBot: true,
    };
  };

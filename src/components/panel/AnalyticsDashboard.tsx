          ...
          <div className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <MetricCard
                         ...
                         icon={<AcademicCapIcon className="h-6 w-6 text-purple-600 dark:text-purple-400" />}
                         trend="+15% tuần này"
                         color="#8B5CF6"
                    />
                    <MetricCard
                         ...
                         icon={<TrophyIcon className="h-6 w-6 text-orange-600 dark:text-orange-400" />}
                         trend="+22% tuần này"
                         color="#F59E0B"
                    />
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <MetricCard
                         ...
                         icon={<CursorArrowRaysIcon className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />}
                         color="#6366F1"
                    />
                    <MetricCard
                         title="Thời gian trung bình"
                         value={`${Math.floor(metrics.avgSessionDuration / 60)}:${(metrics.avgSessionDuration % 60).toString().padStart(2, '0')}`}
                         icon={<ClockIcon className="h-6 w-6 text-pink-600 dark:text-pink-400" />}
                         color="#EC4899"
                    />
                    <MetricCard
                         title="Tỷ lệ thoát"
                         value={`${metrics.bounceRate}%`}
                         icon={<ChartBarIcon className="h-6 w-6 text-red-600 dark:text-red-400" />}
                         color="#EF4444"
                    />
                    <MetricCard
                         title="Tỷ lệ chuyển đổi"
                         value={`${metrics.conversionRate}%`}
                         icon={<TrophyIcon className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />}
                         color="#059669"
                    />
               </div>

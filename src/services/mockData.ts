...
export const courses: Course[] = [
     ...
     },
     {
          ...
          description: 'Khóa học cung cấp kiến thức chuyên sâu về hóa học, giúp học sinh giỏi chuẩn bị cho các kỳ thi học sinh giỏi và đại học.',
     ...
     },
     {
          ...
          description: 'Khóa học giúp trẻ làm quen với tư duy lập trình thông qua các trò chơi và bài tập tương tác thú vị.',
